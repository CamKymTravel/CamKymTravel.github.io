const CACHE='tcc-v4.5.89-morocco-full-simulation-20260817-1';
const APP_SHELL=[
  "./",
  "./index.html",
  "./styles.css",
  "./styles.css?v=4.5.89-morocco-full-simulation-20260817",
  "./app.js",
  "./app.js?v=4.5.89-morocco-full-simulation-20260817",
  "./manifest.webmanifest",
  "./manifest.webmanifest?v=4.5.89-morocco-full-simulation-20260817",
  "./icon.svg",
  "./icon.svg?v=4.5.89-morocco-full-simulation-20260817",
  "./apple-touch-icon.png",
  "./apple-touch-icon.png?v=4.5.89-morocco-full-simulation-20260817",
  "./home-hero.jpg",
  "./home-portugal-lock.jpg",
  "./world-map-premium.png",
  "./world-map-vector.svg",
  "./compass-mark.svg",
  "./compass-mark.svg?v=4.5.89-morocco-full-simulation-20260817",
